...
const CustomButtons = () => {
  ...
  const handleLogout = () => {
    setAccount({ ...account, data: null, token: "" });
  ...
  return (
    <Wrapper>
      {account?.username ? (
        <Box style={{ display: "flex", alignItems: "center", padding: "2px" }}>
          <Typography
            style={{
              marginRight: "5px",
              marginLeft: "5px",
      ...
      <Typography style={{ marginTop: 3, width: "140px", marginRight: 45 }}>
        Become a Seller
      </Typography>
      ...
      <Container to="./cart">
        ...
        <Typography style={{ marginLeft: 10, marginTop: 3, marginRight: 45 }}>
          Cart
        </Typography>
      </Container>
